...
| 应用目录域 | 应用元数据、应用分类、接入方式管理、工具安装包管理 | 是 |
| 资产商店域 | Prompt / Skill / Agent / ToolApp 资产发布、搜索、版本、收藏 | 是 |
...
| 文件分发接入 | 门户托管脚本包、安装包、可执行文件并统一下载审计 | 部门自研 Python 工具、桌面小工具 | 是 |
...
| ToolApp | 部门团队、普通员工 | 部门自研 AI 小工具、Python 程序、桌面脚本或安装包 |
